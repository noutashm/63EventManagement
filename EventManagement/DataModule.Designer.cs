...
namespace EventManagement {
    partial class DataModule {
        ...
        private void InitializeComponent() {
            ...
            this.dsNZESL = new EventManagement.dsNZESL();
    ...
    "NA\r\nORDER BY ArenaID";
            ...
            // dbConn
            // 
            this.dbConn.ConnectionString = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=C:\\temp\\NZESL.mdb";
            // 
            // oleDbInsertCommand1
            // 
    ...
    "city`) VALUES (?, ?, ?, ?, ?)";
            ...
            this.oleDbUpdateCommand2.Connection = this.dbConn;
            ...
            this.oleDbDeleteCommand2.Connection = this.dbConn;
    ...
    "Address`, `FirstName`) VALUES (?, ?, ?, ?, ?, ?)";
            ...
            this.oleDbSelectCommand4.Connection = this.dbConn;
            // 
            // oleDbInsertCommand4
            // 
            this.oleDbInsertCommand4.CommandText = "INSERT INTO `ENTRY` (`ChallengeID`, `CompetitorID`, `Status`) VALUES (?, ?, ?)";
            this.oleDbInsertCommand4.Connection = this.dbConn;
    ...
    "`Status` = ?)))";
            this.oleDbUpdateCommand4.Connection = this.dbConn;
    ...
    " 1 AND `Status` IS NULL) OR (`Status` = ?)))";
            this.oleDbDeleteCommand4.Connection = this.dbConn;
    ...
    "ALUES (?, ?, ?, ?, ?)";
            ...
            this.oleDbUpdateCommand5.Connection = this.dbConn;
            ...
            this.oleDbDeleteCommand5.Connection = this.dbConn;
